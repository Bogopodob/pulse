...
import { useChartConfig } from "@/shared/ui/charts/chart-config-context";
import { useChartHover, useChartStable } from "@/shared/ui/charts/chart-context";
import {
  computeSegmentBounds,
  INACTIVE_SEGMENT,
} from "@/shared/ui/charts/highlight-segment-bounds";
